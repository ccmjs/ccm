 ...
 * version 18.5.1 (14.11.2018): bug fix for ccm.helper.solveDotNotation (deep copy of first parameter)
 ...
 * - ccm.helper.parse is used instead of JSON.parse
 * version 18.4.0 (05.11.2018):
 * - result of ccm.helper.toDotNotation can optionally contain all levels of dot notation
 * - ccm.helper.fillForm uses all levels of dot notation
 * version 18.3.0 (03.11.2018): added ccm.helper.asyncForEach(array,callback)
 * version 18.2.0 (01.11.2018): added ccm.helper.stringify (converts a value to a JSON string and removes not JSON valid data)
      ...
      return new Promise( ( resolve, reject ) => {
        ...
        args.forEach( ( resource, i ) => {
          ...
          function successData( data ) {
            ...
            if ( typeof data === 'string' && self.helper.regex( 'json' ).test( data ) ) data = self.helper.parse( data );
