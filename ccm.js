...
( () => {
  ...
  const self = {
    ...
    instance: async ( component, config ) => {
      ...
      function createInstance() {
        ...
        function setElement() {
          ...
          config.breakpoints !== false && self.helper.responsive( instance.element, config.breakpoints );
    ...
    helper: {
       ...
       */
      responsive: ( element, breakpoints = { SM: 384, MD: 576, LG: 768, XL: 960 } ) => {
