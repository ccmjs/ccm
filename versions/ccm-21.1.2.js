 ...
 * @version 21.1.2
 * @changes
 * version 21.1.2 (05.07.2019):
 * - JSON.parse only for strings in ccm.load
 * version 21.1.1 (02.07.2019):
 * - bug fix for ccm.helper.dataset
 * version 21.1.0 (23.06.2019):
 * - added ccm.context highestByProperty(instance,property,not_me):instance
 * - added ccm.context nearestByProperty(instance,property,not_me):instance
 * version 21.0.1 (12.06.2019):
 * - try-catch for JSON.parse in ccm.load at data exchange result
  ...
  const Datastore = function () {
    ...
    this.get = ( key_or_query={} ) => new Promise( ( resolve, reject ) => {
      ...
      function serverDB() {
        ...
        ( that.socket ? useWebsocket : useHttp )( prepareParams( { get: key_or_query } ) ).then( resolve ).catch( reject );
