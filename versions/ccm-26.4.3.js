 ...
 * @version 26.4.3
 * @changes
 * version 26.4.3 (19.07.2021)
 * - updated ccm.helper.isSubset: added check with regular expression, check for truthy and check for deep properties
 * version 26.4.2 (19.07.2021)
 * - accept also a 403 status code for unauthorized data operations to trigger login
 * version 26.4.1 (15.07.2021)
 * - simplified dynamic loading of modules with import()
 * version 26.4.0 (28.04.2021)
 * - focusable website area (allows component-specific keyboard events)
 * version 26.3.1 (16.04.2021)
 * - bugfix for reconnection on closed websocket
 ...
 * - user token is determined by user.getValue() instead of user.data() if exists
 * version 26.1.1 (01.12.2020)
 * - bug fix for closed websocket connection
 * version 26.1.0 (09.11.2020)
 * - user token and realm can directly be passed via datastore accessor configuration
