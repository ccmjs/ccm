 ...
 * @version 16.7.0
 * @changes
 * version 16.7.0 (28.06.2018)
 * - ccm.load supports loading of XML files
 * version 16.6.1 (24.05.2018)
 * - no search for data dependencies inside of other ccm dependencies
 * version 16.6.0 (15.05.2018)
 * - storing a dataset via ccm.helper.onfinish can make a key unique (array key with appended generated key)
 ...
 * - bugfix in ccm.helper.decodeObject
 * - bugfix for restoring an radio button value
 * - no undefined properties in results of ccm.helper.filterProperties
 * - bugfix for getting value(s) of a selector box
 * version 16.3.1 (25.04.2018)
 * - bugfix for request an empty local datastore via ccm dependency
 * version 16.3.0 (24.04.2018)
 * - ccm.helper.onfinish supports confirm box
 * version 16.2.0 (22.04.2018): better encode/decode handling
 * - renamed ccm.helper.decode to ccm.helper.decodeObject and refactoring of its code
 * - removed ccm.helper.decodeDependencies
 * - renamed ccm.helper.encode to ccm.helper.encodeObject
 * - refactoring code of ccm.helper.encodeDependencies
 * - updated encode/decode handling in ccm.helper.fillForm
 ...
 * version 16.0.1 (12.04.2018)
 * - bugfix in ccm.helper.dataset
